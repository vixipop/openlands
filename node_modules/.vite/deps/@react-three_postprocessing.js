import {
  ...
  ToneMappingEffect,
  VignetteEffect
} from "./chunk-RFXLGTCS.js";
import {
  require_jsx_runtime
} from "./chunk-XUXHEDPB.js";
import {
  isWebGL2Available
} from "./chunk-62365PEV.js";
import {
  applyProps,
  createPortal,
  extend,
...
var ToneMapping = (0, import_react16.forwardRef)(function ToneMapping2({
  blendFunction,
  adaptive,
  mode,
  resolution,
  ...
  const effect = (0, import_react16.useMemo)(
  ...
  return (0, import_jsx_runtime16.jsx)("primitive", { ...props, ref, object: effect, attributes: EffectAttribute.CONVOLUTION });
});
...
var LUT = (0, import_react17.forwardRef)(function LUT2({ lut, tetrahedralInterpolation, ...props }, ref) {
  const effect = (0, import_react17.useMemo)(() => new LUT3DEffect(lut, props), [lut, props]);
  const invalidate = useThree((state) => state.invalidate);
  ...
  return (0, import_jsx_runtime17.jsx)("primitive", { ref, object: effect, dispose: null });
});
...
var ASCII = (0, import_react18.forwardRef)(
  ({
    font = "arial",
    characters = ` .:,'-^=*+?!|0#X%WM@`,
    fontSize = 54,
    ...
    return (0, import_jsx_runtime18.jsx)("primitive", { ref: fref, object: effect });
  }
);
...
// node_modules/@react-three/postprocessing/dist/effects/SSR/index.js
var SSR = (0, import_react19.forwardRef)(function SSR2({ ENABLE_BLUR = true, USE_MRT = true, ...props }, ref) {
  const { invalidate } = useThree();
  const { scene, camera } = (0, import_react19.useContext)(EffectComposerContext);
  const effect = (0, import_react19.useMemo)(
    () => new SSREffect(scene, camera, { ENABLE_BLUR, USE_MRT, ...props }),
    [scene, camera, ENABLE_BLUR, USE_MRT, props]
  );
  const api = (0, import_react19.useContext)(selectionContext);
  ...
  return (0, import_jsx_runtime19.jsx)("primitive", { ref, object: effect, ...props });
});
...
// node_modules/@react-three/postprocessing/dist/effects/N8AO/index.js
var N8AO = (0, import_react20.forwardRef)(
  ({
    halfRes,
    screenSpaceRadius,
    quality,
    ...
    const effect = (0, import_react20.useMemo)(() => new N8AOPostPass(scene, camera), []);
    ...
    return (0, import_jsx_runtime20.jsx)("primitive", { ref, object: effect });
  }
);
export {
  ASCII,
